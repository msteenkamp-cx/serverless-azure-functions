...
var ConfigService = /** @class */ (function () {
    ...
    ConfigService.prototype.registerCliCommands = function () {
        ...
        this.cliCommandFactory.registerCommand(runtime_1.Runtime.DOTNET60 + "-" + runtime_1.BuildMode.RELEASE, {
            command: "dotnet",
            args: [
                "build",
                "--configuration",
        ...
        this.cliCommandFactory.registerCommand(runtime_1.Runtime.DOTNET60 + "-" + runtime_1.BuildMode.DEBUG, {
            command: "dotnet",
            args: [
                "build",
                "--configuration",
